...
> 来源：[Leey21/awesome-ai-research-writing](https://github.com/Leey21/awesome-ai-research-writing)（⭐ 14,000+）
> 调研自 MSRA、Seed、SH AI Lab 等顶尖机构研究员及北大/中科大/上交硕博的实战 prompt
> 整理时间：2026-06-02
...
| #   | Prompt                           | 适用场景                  |
| --- | -------------------------------- | --------------------- |
| 1   | [中转英-LaTeX](#1-中转英-latex)        | 中文草稿 → 英文 LaTeX 论文    |
| 2   | [英转中-LaTeX](#2-英转中-latex)        | 英文 LaTeX → 中文直译（辅助阅读） |
| 3   | [中转英-Word](#3-中转英-word)          | 中文草稿 → 英文 Word 论文     |
| 4   | [中转中-Word](#4-中转中-word)          | 口语化中文 → 中文学术论文        |
| 5   | [缩写](#5-缩写)                      | 英文文本微幅缩减（5-15词）       |
| 6   | [扩写](#6-扩写)                      | 英文文本微幅扩展（5-15词）       |
| 7   | [表达润色-英文论文](#7-表达润色-英文论文)        | 英文 LaTeX 深度润色         |
| 8   | [表达润色-中文论文](#8-表达润色-中文论文)        | 中文论文润色                |
| 9   | [逻辑检查](#9-逻辑检查)                  | 终稿红线审查                |
| 10  | [去AI味-LaTeX英文](#10-去ai味-latex英文) | 英文论文去机器感              |
| 11  | [去AI味-Word中文](#11-去ai味-word中文)   | 中文论文去机器感              |
| 12  | [论文架构图](#12-论文架构图)               | AI 绘制论文框架图            |
| 13  | [实验绘图推荐](#13-实验绘图推荐)             | 根据数据推荐图表类型            |
| 14  | [生成图的标题](#14-生成图的标题)             | 中文描述 → 英文图标题          |
| 15  | [生成表的标题](#15-生成表的标题)             | 中文描述 → 英文表标题          |
| 16  | [实验分析](#16-实验分析)                 | 实验数据 → 分析段落           |
| 17  | [Reviewer视角审视](#17-reviewer视角审视) | 模拟审稿人审读全文             |
| —   | [模型选择建议](#模型选择建议)                | 写作/代码用什么模型            |

---

## 1. 中转英-LaTeX

**场景**：中文草稿 → 英文 LaTeX 论文片段
...
**场景**：中文草稿 → 英文 Word 论文（不做 LaTeX 转义，适合 Word 用户）
...
**场景**：英文 LaTeX 微幅缩减（约5-15词），保持所有信息不变
...
**场景**：英文 LaTeX 微幅扩展（约5-15词），增强逻辑连接
...
**场景**：英文论文去机器感，让文字像母语研究者写的

> ⚠️ **AI味浓的单词列表**（出现时可考虑替换）：
> Accentuate, Ador, Amass, Ameliorate, Amplify, Alleviate, Ascertain, Advocate, Articulate, Bolster, Bustling, Cherish, Conceptualize, Conjecture, Consolidate, Convey, Culminate, Decipher, Demonstrate, Depict, Devise, Delineate, **Delve**, Delve Into, Diverge, Disseminate, Elucidate, Endeavor, Engage, Enumerate, Envision, Enduring, Exacerbate, Expedite, Foster, Galvanize, Harmonize, Hone, Innovate, Integrate, Interpolate, Intricate, **Leverage**, Manifest, Mediate, Nurture, Nuance, Nuanced, Obscure, Perceive, Perpetuate, Permeate, Pivotal, Ponder, Prescribe, Prevailing, Profound, Recapitulate, Reconcile, Rectify, Rekindle, Reimagine, Scrutinize, Substantiate, Tailor, Testament, Transcend, Traverse, Underscore, Unveil, Vibrant
...
**场景**：AI 绘制顶会风格的论文架构图（含中英文两版 prompt）
...
**场景**：根据实验数据推荐最合适的图表类型（含19种标准学术图表）
...
> 💡 配色参考：[HTML Color Codes 颜色选择器](https://htmlcolorcodes.com/zh/yanse-xuanze-qi/)

---

## 14. 生成图的标题

**场景**：中文描述 → 英文 figure caption
...
**场景**：实验数据 → LaTeX 分析段落（含 \paragraph 结构）
...
| 场景              | 推荐模型                                |
| --------------- | ----------------------------------- |
| 日常 idea 交互、论文写作 | **Gemini 3 Pro / Flash**            |
| 实验代码编写          | **Claude 4.5 系列** + Cursor Composer |
| GPT 系列          | GPT 5.5                             |

> 数据来源：[arena.ai Creative Writing 排名](https://arena.ai/zh/leaderboard/text/creative-writing)

---

## 🤖 Part II: Agent Skills 速查

适合 Cursor / Claude Code 用户，一键安装：
...
| Skill                   | 来源             | 功能                                                     |
| ----------------------- | -------------- | ------------------------------------------------------ |
| **20-ml-paper-writing** | zechenzhangAGI | 完整论文写作：从 repo 起稿、LaTeX 模板、引用验证、审稿人视角、会议 checklist、格式迁移 |
| **humanizer**           | blader         | 去 AI 味：识别过度强调/促销腔/破折号滥用/AI高频词，注入人味                     |
| **docx**                | anthropics     | Word 文档创建/编辑/修订痕迹（tracked changes）                     |
| **doc-coauthoring**     | anthropics     | 分阶段协作：上下文→头脑风暴→起草→精修→读者测试                              |
| **canvas-design**       | anthropics     | 论文概念图/示意图/框架图，导出 .pdf/.png                             |

---

> 📌 **核心理念**：不要在 prompt 调试上浪费时间，把精力留给真正的科研。
